...
var mr = class {
  ...
  getOrCreateViewModel(t) {
    if (!t) {
      ...
      const a = { root: true, toasts: [], container: void 0, id: /* @__PURE__ */ Symbol("toast") };
...
function Jl(e, t = Ut) {
  ...
  const l = { id: /* @__PURE__ */ Symbol("toastInstance") }, n = { ...br, ...l, ...e }, r = a.getOrCreateViewModel(n);
  return new La(r);
}
var gr = {
  install: (e, t = {}) => {
